  ...
  const columns = [
    {
      ...
      width: 200,
      renderCell: (params) => (
        <span style={{ color: 'black' }}>{params.value}</span>
      ),
    },
    {
      field: 'budget',
              ...
              <Grid container spacing={2}>
                ...
                <Grid item xs={12} sm={6}>
                  <TextField
                    ...
                    name="startDate"
                    type="date"
                    defaultValue={new Date(selectedProject.startDate).toISOString().split('T')[0]}
                    fullWidth
                    required
                ...
                <Grid item xs={12} sm={6}>
                  <TextField
                    ...
                    name="endDate"
                    type="date"
                    defaultValue={new Date(selectedProject.endDate).toISOString().split('T')[0]}
                    fullWidth
                    required
                    InputLabelProps={{ shrink: true }}
                  />
